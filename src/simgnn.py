...
class SimGNN(torch.nn.Module):
    ...
    def convolutional_pass(self, edge_index,edge_weight, features):
        """
    ...
    def forward(self, data):
        ...
        edge_wt_1 = data["edge_wt_1"]
        edge_wt_2 = data["edge_wt_2"]

        abstract_features_1 = self.convolutional_pass(edge_index_1,edge_wt_1, features_1)
        abstract_features_2 = self.convolutional_pass(edge_index_2,edge_wt_2, features_2)
...
class SimGNNTrainer(object):
    ...
    def transfer_to_torch(self, data):
        ...
        """
        new_data = dict()
        edges_1 = data["graph_1"] + [[y, x,z] for x, y,z in data["graph_1"]]

        edges_2 = data["graph_2"] + [[y, x,z] for x, y,z in data["graph_2"]]
        edges_1 = [[x,y] for x, y,z in data["graph_1"]]
        edges_2 = [[x,y] for x, y,z in data["graph_2"]]
        edges_wt_1 = [z for x, y,z in data["graph_1"]]
        edges_wt_2 = [z for x, y,z in data["graph_2"]]
        ...
        new_data["edge_wt_1"] = torch.from_numpy(np.array(edges_wt_1))
        new_data["edge_wt_2"] = torch.from_numpy(np.array(edges_wt_2))
